...
function newobject(object, type, key)
	...
	return assert.results(ServerBroker.broker:object(object, key, type))
end
...
function newthread(body, ...)
	...
	return TaskManager.tasks:start(body, ...)
end
