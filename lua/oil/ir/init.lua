...
local PrimitiveDef            = oo.class({ __idltype = "IDL:omg.org/CORBA/PrimitiveDef:1.0"            }, IDLType)
local ArrayDef                = oo.class({ __idltype = "IDL:omg.org/CORBA/ArrayDef:1.0"                }, IDLType)
local SequenceDef             = oo.class({ __idltype = "IDL:omg.org/CORBA/SequenceDef:1.0"             }, IDLType)
local StringDef               = oo.class({ __idltype = "IDL:omg.org/CORBA/StringDef:1.0"               }, IDLType)
--local WstringDef              = oo.class({ __idltype = "IDL:omg.org/CORBA/WstringDef:1.0"              }, IDLType)
--local FixedDef                = oo.class({ __idltype = "IDL:omg.org/CORBA/FixedDef:1.0"                }, IDLType)

local AttributeDef            = oo.class({ __idltype = "IDL:omg.org/CORBA/AttributeDef:1.0"            }, Contained)
...
local EnumDef                 = oo.class({ __idltype = "IDL:omg.org/CORBA/EnumDef:1.0"                 }, TypedefDef)
local AliasDef                = oo.class({ __idltype = "IDL:omg.org/CORBA/AliasDef:1.0"                }, TypedefDef)
--local NativeDef               = oo.class({ __idltype = "IDL:omg.org/CORBA/NativeDef:1.0"               }, TypedefDef)
--local ValueBoxDef             = oo.class({ __idltype = "IDL:omg.org/CORBA/ValueBoxDef:1.0"             }, TypedefDef)

local Repository              = oo.class({ __idltype = "IDL:omg.org/CORBA/Repository:1.0"              }, ObjectManager, Container)
local ModuleDef               = oo.class({ __idltype = "IDL:omg.org/CORBA/ModuleDef:1.0"               }, Contained, Container)
local ExceptionDef            = oo.class({ __idltype = "IDL:omg.org/CORBA/ExceptionDef:1.0"            }, Contained, Container)
local InterfaceDef            = oo.class({ __idltype = "IDL:omg.org/CORBA/InterfaceDef:1.0"            }, IDLType, Contained, Container)
--local ValueDef                = oo.class({ __idltype = "IDL:omg.org/CORBA/ValueDef:1.0"                }, Container, Contained, IDLType)

--local AbstractInterfaceDef    = oo.class({ __idltype = "IDL:omg.org/CORBA/AbstractInterfaceDef:1.0"    }, InterfaceDef)
--local LocalInterfaceDef       = oo.class({ __idltype = "IDL:omg.org/CORBA/LocalInterfaceDef:1.0"       }, InterfaceDef)

--local ExtAttributeDef         = oo.class({ __idltype = "IDL:omg.org/CORBA/ExtAttributeDef:1.0"         }, AttributeDef)
--local ExtValueDef             = oo.class({ __idltype = "IDL:omg.org/CORBA/ExtValueDef:1.0"             }, ValueDef)
--local ExtInterfaceDef         = oo.class({ __idltype = "IDL:omg.org/CORBA/ExtInterfaceDef:1.0"         }, InterfaceDef, InterfaceAttrExtension)
--local ExtAbstractInterfaceDef = oo.class({ __idltype = "IDL:omg.org/CORBA/ExtAbstractInterfaceDef:1.0" }, AbstractInterfaceDef, InterfaceAttrExtension)
--local ExtLocalInterfaceDef    = oo.class({ __idltype = "IDL:omg.org/CORBA/ExtLocalInterfaceDef:1.0"    }, LocalInterfaceDef, InterfaceAttrExtension)
